...
public class BaseDTO implements Serializable{
    ...
    private static final long serialVersionUID = -3694058817696067017L;
    ...
    /**
     * @return the encFieldValue
     */
    public String getEncFieldValue() {
        return encFieldValue;
    }

    /**
     * @param encFieldValue the encFieldValue to set
     */
    public void setEncFieldValue(String encFieldValue) {
        this.encFieldValue = encFieldValue;
    }
