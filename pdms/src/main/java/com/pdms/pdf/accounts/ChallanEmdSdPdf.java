 ...
 */
@Component
public class ChallanEmdSdPdf extends AbstractPDFViewHelper{
    private static final Logger logger = Logger.getLogger(ChallanEmdSdPdf.class.getName());
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document doc,
        ...
        List<ChequeDdEntryDTO> emdObj = (List<ChequeDdEntryDTO>)model.get("challEmdObj");
        for(ChequeDdEntryDTO obj: emdObj){
        ...
        cell.setPhrase(new Phrase("Phone No: 040-27181215", font));
        ...
        cell2.setPhrase(new Phrase("CHALLAN NO:- RPUM/HWP/ACCOUNTS/CASH/ "+obj.getChallanNo()+" / 2017-2018  Date: "+obj.getChallanDate(), font1));
        headerTable2.addCell(cell2).setHorizontalAlignment(Element.ALIGN_CENTER); 
        ...
        Font font12 = new Font(FontFamily.HELVETICA, 12f, Font.UNDERLINE);
        Chunk cs = new Chunk("SHORT CODE", font12);
        Paragraph ps = new Paragraph("SHORT CODE", font12);
        ...
        cell3.setPhrase(new Phrase("Accounts Officer, RPUM, DPS, DAE,", font3));
        cell3.setFixedHeight(170f);
        cell3.setPaddingTop(10f);
        headerTable3.addCell(cell3);        
        cell3.setPhrase(new Phrase("Accounts Officer, RPUM, DPS,DAE, DAE Colony, ECIL, Hyderabad-62. ", font3));
        cell3.setFixedHeight(170f);
        cell3.setPaddingTop(10f);
        headerTable3.addCell(cell3);        
        cell3.setPhrase(new Phrase("EMD ", font3));
        cell3.setFixedHeight(170f);
        cell3.setPaddingTop(10f);
        headerTable3.addCell(cell3);
        cell3.setPhrase(new Phrase(" "+obj.getAmount(), font3));
        cell3.setFixedHeight(170f);
        cell3.setPaddingTop(10f);
        headerTable3.addCell(cell3);        
        cell3.setPhrase(new Phrase(obj.getHeadOfAc()+"\n\n "+ps+"\n\n "+obj.getHead(), font3));
        cell3.setFixedHeight(170f);
        cell3.setPaddingTop(10f);
        headerTable3.addCell(cell3);        
        cell3.setPhrase(new Phrase("AO, RPUM, DPS, DAE, Hyderabad. ", font3));
        cell3.setFixedHeight(170f);
        cell3.setPaddingTop(10f);
        headerTable3.addCell(cell3);
