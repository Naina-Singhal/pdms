<%-- 
    Document   : CommonCSS
    Created on : Mar 10, 2015, 8:37:39 PM
    Author     : hpasupuleti
--%>
...
<link rel="stylesheet" href="<c:url value="/assets/js/vendor/datatables/css/jquery.dataTables.css"/>">
...
<link rel="stylesheet" href="<c:url value="/assets/css/second-main.css"/>">
<!--/ stylesheets -->
...
<link rel="stylesheet" href="<c:url value="assets/js/vendor/datatables/datatables.bootstrap.min.css"/>">
<link rel="stylesheet" href="<c:url value="assets/js/vendor/datatables/extensions/ColReorder/css/dataTables.colReorder.min.css"/>">
<link rel="stylesheet" href="<c:url value="assets/js/vendor/datatables/extensions/Responsive/css/dataTables.responsive.css"/>">
<link rel="stylesheet" href="<c:url value="assets/js/vendor/datatables/extensions/ColVis/css/dataTables.colVis.min.css"/>">
<link rel="stylesheet" href="<c:url value="assets/js/vendor/datatables/extensions/TableTools/css/dataTables.tableTools.min.css"/>">
