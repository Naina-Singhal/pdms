<%-- 
    Document   : HOAList
    Created on : Sep 30, 2016, 9:37:55 PM
    Author     : hpasupuleti
--%>
...
<html lang="en">
    <head>
        ...
        <title>RPUM : Head Of Account List</title>
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>Head Of Account(s) <span> Add/ Update Head Of Account(s)</span></h2>
                        <div class="page-bar">
                    ...
                    <div class="pagecontent">
                        ...
                        <%-- **************************************************************** --%>
                        <div class="row">
                            <spring:form name="addHoaForm" commandName="hoaObj" >
                                <!-- col -->
                                <div class="col-md-12">
                                    <!-- tile -->
                                    <section class="tile">
                                        ...
                                        <div class="tile-header dvd dvd-btm">
                                            <h1 class="custom-font"><strong>Head Of Account</strong> Details</h1>
                                        </div>
                                        <!-- tile header -->
                                        <!-- tile body -->
                                        <div class="tile-body">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="accountType" id='accountType' 
                                                           ...
                                                           maxlength="40"/>
                                                    <label id="erroraccountType" style="color: red"></label>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="username">Head Of Account Code: </label>
                                                    <input type="text" name="accountCode" id='accountCode' 
                                                           class="form-control input-sm"
                                                           maxlength="10"/>
                                                    <label id="erroraccountCode" style="color: red"></label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <label id="errordescription" style="color: red"></label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-7">
                                            ...
                                            <table class="table table-custom" id="basic-usage" style="width:100% !important">
                                                ...
                                                <tbody>
                                                    <c:if test="${hoaLi != null}">
                                                        ...
                                                        <c:forEach var="hoaObj" items="${hoaLi}">
                                                            <tr class="gradeX">
                                                                <td>${loopCount}</td>
                                                                <td>${hoaObj.accountType}</td>
                                                                <td>${hoaObj.accountCode}</td>
                                                                <td>${hoaObj.description}</td>
                                                                <td>
                                                                    <button type='button' 
                                                                            class="btn btn-info btn-rounded btn-sm"
                                                                            onclick="fnEditHoa('${fn:trim(hoaObj.encFieldValue)}')">Edit
                                                                    </button>
                                                                </td>
                                                            </tr>
        ...
        <script src="<c:url value="/appjs/hoaJS.js"/>" type="text/javascript"></script>
        <!-- ===============================================
