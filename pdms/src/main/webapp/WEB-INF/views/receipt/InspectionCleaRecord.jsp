...
<un:useConstants className="com.pdms.constants.ApplicationConstants" var="constants" /><c:if test="${userPermiLi != null}">
...
<html lang="en">
    <head>
        ...
        <title>RPUM : Inspection Clearance(s) List</title>
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>Inspection Clearance(s) <span>  List(s)</span></h2>
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="#">Inspection Clearance Record(s)</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile">
                                    ...
                                    <div class="tile-header dvd dvd-btm">
                                        <h1 class="custom-font"><strong>Inspection Clearance(s)</strong> List</h1>
                                        <div class="open_page_button">
                                            <c:if test="${(userPermiLi.c5 == 1)}">                                                
                                                    <button type='button' 
                                                            class="btn btn-info btn-rounded btn-sm"
                                                            onclick="openInspecForm();">Inspection Clearance Entry
                                                    </button> 
                                            </c:if>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tile-body" style="overflow-x: scroll">
                                        <div class="table-responsive">
                                            <table class="table table-custom row-border hover order-column" id="basic-usage" cellspacing="0" style="width:100% !important;">
                                                ...
                                                <tbody>
                                                    <%  int slno = 0;   %>
                                                    <c:if test="${Inpse_Record != null}">
                                                        <c:forEach var="icObj" items="${Inpse_Record}">
                                                            <tr class="gradeX">
                                                                <td><%= ++slno %></td>
                                                                <td>${icObj.dbNumber}</td>
                                                                <td>${icObj.section}</td>
                                                                <td>${icObj.poLastNo}</td>
                                                                <td>${icObj.poDate}</td>
                                                                <td>${icObj.grOrrNumber}</td>
                                                                <td>${icObj.grOrrDate}</td>
                                                                <td>
                                                                    <button type='button' style="" id="form_view" 
                                                                            class="btn btn-info btn-rounded btn-sm" 
                                                                            >Edit</button>                                        
                                                                    <button type='button' 
                                                                            class="btn btn-info btn-rounded btn-sm"
        ...
        <script src="<c:url value="/appjs/receipt/InspectionReJS.js"/>" type="text/javascript"></script>
