...
<html lang="en">
    <head>
        ...
        <title>RPUM : RCIV Control Record(s) List</title>
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>RCIV Control Record(s) <span>  List(s)</span></h2>
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="#">RCIV Control Record(s)</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile">
                                    ...
                                    <div class="tile-header dvd dvd-btm">
                                        <h1 class="custom-font"><strong>RCIV Control Record(s)</strong> List</h1>
                                        <div class="open_page_button">
                                            <c:if test="${(userPermiLi.c9 == 1)}">                                                
                                                    <button type='button' 
                                                            class="btn btn-info btn-rounded btn-sm"
                                                            onclick="openRcivForm();">RCIV Control Entry
                                                    </button> 
                                            </c:if>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tile-body" style="overflow-x: scroll">
                                        <div class="table-responsive">
                                            <table class="table table-custom row-border hover order-column" id="basic-usage" cellspacing="0" style="width:100% !important;">
                                                ...
                                                <tbody>
                                                    <% int slno = 0;    %>
                                                    <c:if test="${ConRecord != null}">
                                                        <c:forEach var="mrObj" items="${ConRecord}">
                                                            <tr class="gradeX">
                                                                <td><%= ++slno %></td> 
                                                                <td>${mrObj.indentorC}</td>
                                                                <td>${mrObj.indentorNoC}</td>
                                                                <td class="less-more">${mrObj.deliveryAtC}</td>
                                                                <td>${mrObj.authorisedByNameC}</td>
                                                                <td>${mrObj.releasedByNameC}</td>                                                                                                                               
                                                                <td class="less-more">${mrObj.releasedRemarksC}</td>
                                                                <td> 
                                                                    <button type='button' 
                                                                            class="btn btn-info btn-rounded btn-sm"
                                                                            onclick="">Edit
        ...
        <script src="<c:url value="/appjs/receipt/RcivControlReJS.js"/>" type="text/javascript"></script>
