           ...
           <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>RCIV Control(s) <span> Add/ Update User(s)</span></h2>
                        <div class="page-bar">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group div-wid-7">
                                                    ...
                                                    <select name="" id="" class="form-control input-sm">
                                                        <option value="">Yet to authorise</option>
                                                        <option value="">Authorised but material yet to be issued</option>
                                                        <option value="">Not authorised / cancelled</option>
                                                    </select>
