<%-- 
    Document   : ViewIndentForm
    Created on : Oct 4, 2016, 10:30:42 PM
    Author     : hpasupuleti
--%>
                                        ...
                                        <div class="tile-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 col-lg-4">
                                                    ...
                                                    <label>${indentSObj.mopObj.modeOfPurchase}</label><br/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6 col-lg-4">
                                                    ...
                                                    <label>${indentSObj.indentStatus}</label>
                                                </div>
                                                ...
                                                <c:if test="${(indentSObj.indentStatus == constants.INDENT_STATUS_MAPPED)}">
                                                    <div class="form-group col-md-6 col-lg-4">
