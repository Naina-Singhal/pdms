<%-- 
    Document   : IndentFileUpload
    Created on : Dec 23, 2016, 6:39:20 AM
    Author     : hpasupuleti
--%>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <span class="tools pull-right">
                                                <input type="button" value="Skip Upload" class="btn btn-info " id="skipUpload" />
                                                <input type="button" value="Submit" class="btn btn-info" id="saveFiles"/> 
                                            </span>
                                        </div>
                                    </div>
                                </div>
