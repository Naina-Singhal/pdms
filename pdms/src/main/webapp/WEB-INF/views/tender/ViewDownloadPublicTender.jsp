<%-- 
    Document   : ViewDownloadPublicTender
    Created on : Feb 21, 2017, 12:51:22 PM
    Author     : hpasupuleti
--%>
            ...
            <spring:form name="vTenderForm" commandName="tenderObj">
                <section id="content">
                    <div class="page">
                        ...
                        <div class="pageheader">
                            <h2>Tender Form <span> Download Tender Information</span></h2>
                            <div class="page-bar">
                        ...
                        <div class="pagecontent">
                            <div class="row">
                                ...
                                <c:choose>
                                    <c:when test="${tenderObj.ptVendorObj.vendorID > 0}">
                                ...
                                <div class="col-md-12">
                                    <span class="tools pull-right">
                                        <input type="button" value="Download Excel" 
                                               class="btn btn-info " id="dwndExcelView" />
                                        <input type="button" value="Download Tender PDF" 
                                               class="btn btn-info " id="tenderPDF"  />
                                               <!--onclick="fnDownloadTenderPDF()"/> -->
                ...
                <script>
                    $(document).ready(function () {
                        ...
                        $("#tenderPDF").click(function(){
                             //alert("In PDF Download");
                             var tenId= '${fn:trim(tenderObj.encTenderID)}';
                             window.open("<c:url value="tenderpdf.htm?etid="/>"+tenId);
                        });
                        
                        $("#dwndExcelView").click(function(){
                             //alert("In Excel Download");
                             var tenId= '${fn:trim(tenderObj.encTenderID)}';
                             window.open("<c:url value="tenderxls.htm?etid="/>"+tenId);
                        });
                    });
                    ...
                    /* 
                    function fnDownloadTenderPDF()
                    {
                                       
                        document.vTenderForm.action = "<c:url value="tenderpdf.htm?etid=${tenderObj.encTenderID}"/>";
                        document.vTenderForm.submit();
