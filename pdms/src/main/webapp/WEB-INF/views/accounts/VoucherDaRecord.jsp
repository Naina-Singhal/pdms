...
<html lang="en">
    <head>
        ...
        <title>RPUM : Voucher Data Record(s) List</title>
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>Voucher Data Record(s) <span>  List(s)</span></h2>
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="#">Voucher Data Record(s)</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="open_page_button">
                                            <c:if test="${(userPermiLi.d1 == 1)}">                                                
                                                    <button type='button' 
                                                            ...
                                                            onclick="openVouchForm();">Voucher Data Entry
                                                    </button> 
                                            </c:if>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tile-body" style="overflow-x: scroll">
                                        <div class="table-responsive">
                                            <table class="table table-custom row-border hover order-column" id="basic-usage" cellspacing="0" style="width:100% !important;">
                                                ...
                                                <tbody>
                                                    <% int slno = 0;    %>
                                                    <c:if test="${VouRecord != null}">
                                                        <c:forEach var="mrObj" items="${VouRecord}">
                                                            <tr class="gradeX">
                                                                <td><%= ++slno %></td> 
                                                                <td>${mrObj.posrFileNo}</td>
                                                                <td>${mrObj.nameOfSupplr}</td>
                                                                <td>${mrObj.modeOfPaymt}</td>
                                                                <td>${mrObj.pprNo}</td>
                                                                <td>${mrObj.ibcNo}</td>                                                                                                                               
                                                                <td class="less-more">${mrObj.rsInWords}</td>
                                                                <td> 
                                                                    <button type='button' 
                                                                            class="btn btn-info btn-rounded btn-sm"
                                                                            onclick="">Edit
        ...
        <script src="<c:url value="/appjs/account/VoucherReJS.js"/>" type="text/javascript"></script>
