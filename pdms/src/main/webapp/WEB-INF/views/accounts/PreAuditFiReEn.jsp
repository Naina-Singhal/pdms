...
<html lang="en">
    ...
    <body id="minovate" class="appWrapper">
           ...
           <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>Pre Audit File Receipt Entry(s) <span> Add/ Update User(s)</span></h2>
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="#">Pre Audit File Receipt Entry(s)</a>
                                </li>
                            </ul>
                        </div>
                    </div>                
                                ...
                                <div class="col-md-12">
                                    ...
                                    <section class="tile">
                                        ...
                                        <div class="tile-header dvd dvd-btm">
                                            <h1 class="custom-font"><strong>Pre Audit File Receipt Entry</strong> List</h1>
                                        </div>
                                        <!-- tile header -->
                                        <!-- tile body -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span class="tools pull-right">
                                    <input type="button" value="Save" class="btn btn-info" id="savePreAudit"/> 
        ...
        <script src="<c:url value="/appjs/PreAuditEnJS.js"/>" type="text/javascript"></script>
