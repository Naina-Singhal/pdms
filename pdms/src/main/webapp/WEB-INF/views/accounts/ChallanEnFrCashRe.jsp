...
<html lang="en">
    <head>
        ...
        <title>RPUM : Challan Entry For Cash Record(s) List</title>
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>Challan Entry For Cash Record(s) <span>  List(s)</span></h2>
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="#">Challan Entry For Cash Record(s)</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile">
                                    ...
                                    <div class="tile-header dvd dvd-btm">
                                        <h1 class="custom-font"><strong>Challan Entry For Cash Record(s)</strong> List</h1>
                                        <div class="open_page_button">
                                            <c:if test="${(userPermiLi.d12 == 1)}">                                                
                                                    <button type='button' 
                                                            class="btn btn-info btn-rounded btn-sm"
                                                            onclick="openChallanEnForm();">Challan Entry For Cash
                                                    </button> 
                                            </c:if>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tile-body" style="overflow-x: scroll">
                                        <div class="table-responsive">
                                            <table class="table table-custom row-border hover order-column" id="basic-usage" cellspacing="0" style="width:100% !important;">
                                                ...
                                                <tbody>
                                                    <% int slno = 0;    %>
                                                    <c:if test="${ChaRecord != null}">
                                                        <c:forEach var="mrObj" items="${ChaRecord}">
                                                            <tr class="gradeX">
                                                                <td><%= ++slno %></td> 
                                                                <td>${mrObj.challanNo}</td>
                                                                <td>${mrObj.challanDate}</td>
                                                                <td>${mrObj.challanAmt}</td>
                                                                <td  class="less-more">${mrObj.headOfAc}</td>
        ...
        <script src="<c:url value="/appjs/account/ChallanEnFrReJS.js"/>" type="text/javascript"></script>
