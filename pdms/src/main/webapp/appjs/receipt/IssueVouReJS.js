...
$(document).ready(function () {
    ...
    var table = $('#basic-usage').dataTable({
        ...
        "columns": [
            {title: "SL No", width: '5%'},
            {title: "Iv Control No", width: '10%'},
            {title: "Date", width: '15%'},
            {title: "Section", width: '11%'},
            {title: "Part No", width: '13%'},
            {title: "Indentor Name", width: '15%'},
            {title: "Rate", width: '15%'},
...
function openIssueVouForm() {

    window.open("./issueVocherEntry.htm", "_parent");
}
