...
$(document).ready(function () {
    ...
    show_record();    
    //**************************************************************************
    //Start Save Type master in data base
    //**************************************************************************
    ...
    //**************************************************************************    
    //END Save Type master  details in data base
    //**************************************************************************
    
    //**************************************************************************    
    //START: display Type master record
    //**************************************************************************
	...
	async: false,        
        success: function(enquiry){            
            ...
            final = final +"<tr class='gradeX'>"+
                           "<td>"+ (slno++) +"</td>"+
                           "<td>"+v.code+"</td><td>"+v.type+"</td>"+                                                     
                           "<td><button type='button' class='btn btn-info btn-rounded btn-sm' "+
                           "id='ButBut' value=" + v.typeId + ">Edit </button></td> ";
