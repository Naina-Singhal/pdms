...
<html lang="en">
    <head>
        ...
        <title>RPUM : RCIV Authorization Record(s) List</title>
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>RCIV Authorization Record(s) <span>  List(s)</span></h2>
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="#">RCIV Authorization Record(s)</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile">
                                    ...
                                    <div class="tile-header dvd dvd-btm">
                                        <h1 class="custom-font"><strong>RCIV Authorization Record(s)</strong> List</h1>
                                        <div class="open_page_button">
                                            <c:if test="${(userPermiLi.c9 == 1)}">                                                
                                                    <button type='button' 
                                                            class="btn btn-info btn-rounded btn-sm"
                                                            onclick="openRcivForm();">RCIV Authorization Entry
                                                    </button> 
                                            </c:if>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tile-body" style="overflow-x: scroll">
                                        <div class="table-responsive">
                                            <table class="table table-custom row-border hover order-column" id="basic-usage" cellspacing="0" style="width:100% !important;">
                                                ...
                                                <tbody>
                                                    <% int slno = 0;    %>
                                                    <c:if test="${AthuRecord != null}">
                                                        <c:forEach var="auObj" items="${AthuRecord}">
                                                            <tr class="gradeX">
                                                                <td><%= ++slno %></td> 
                                                                <td>${auObj.indentor}</td>
                                                                <td>${auObj.date}</td>
                                                                <td class="less-more">${auObj.deliveryAt}</td>
                                                                <td class="less-more">${auObj.authorisedName}</td>
                                                                <td class="less-more">${auObj.section}</td>                                                                                                                               
                                                                <td class="less-more">${auObj.remarks}</td>
                                                                <td> 
                                                                    <button type='button' 
                                                                            class="btn btn-info btn-rounded btn-sm"
                                                                            onclick="">Edit
        ...
        <script src="<c:url value="/appjs/receipt/RcivAuthoReJS.js"/>" type="text/javascript"></script>
