        ...
        <c:if test="${(userPermiLi.d2 == 1)}">  
            ...
            <html lang="en">
                <head>
                    ...
                    <title>RPUM : BG Remainder(s) List</title>
                ...
                <body id="minovate" class="appWrapper">
                        ...
                        <section id="content">
                            <div class="page">
                                ...
                                <div class="pageheader">
                                    <h2>BG Remainder(s) <span> Add/ Update User(s)</span></h2>
                                    <div class="page-bar">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <section class="tile">
                                                        ...
                                                        <div class="tile-header dvd dvd-btm">                                            
                                                            <h1 class="custom-font"><strong>BG Remainder(s)</strong> Details</h1>
                    ...
                    <script src="<c:url value="/appjs/purchase/BgRemainderJS.js"/>" type="text/javascript"></script>
