<%-- 
    Document   : ViewPublicTenderIndent
    Created on : Oct 28, 2016, 8:49:17 AM
    Author     : hpasupuleti
--%>
        ...
        <div id="wrap" class="animsition">
            ...
            <spring:form name="vTenderForm" commandName="tenderObj">
                ...
                <script>
                    ...
                    {
                        document.vTenderForm.action="<c:url value="pudtenderindli.htm"/>";
