...
<html lang="en">
    <head>
        ...
        <title>RPUM : Type of Dispatch</title>
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>Type of Dispatch(s) <span> Add/ Update Group(s)</span></h2>
                        <div class="page-bar">
                    ...
                    <div class="pagecontent">
                        ...
                        <%-- **************************************************************** --%>
                        <%-- ******** START : ADD/EDIT TYPE OF DISPATCH DETAIL(S)***************** --%>
                        <%-- **************************************************************** --%>
                        <div class="row">
                            <spring:form  id="type_dispatch_form">
                                <!-- col -->
                                <div class="col-md-12">
                                    <!-- tile -->
                                    <section class="tile">
                                        ...
                                        <div class="tile-header dvd dvd-btm">
                                            <h1 class="custom-font"><strong>Type of Dispatch</strong> Details</h1>
                                        </div>
                                        <!-- tile header -->
                                        <!-- tile body -->
                                        <div class="tile-body">
                                            <input type="hidden" id="typeDispatchId" name="typeDispatchId" value=""/>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="username"> Type of Dispatch Name: </label>
                        ...
                        <%-- **************************************************************** --%>
                        <%-- ********** END : ADD/EDIT TYPE OF DISPATCH DETAIL(S)***************** --%>
                        <%-- **************************************************************** --%>
        ...
        <script src="<c:url value="/appjs/master/TypeofdispatchJs.js"/>" type="text/javascript"></script>
