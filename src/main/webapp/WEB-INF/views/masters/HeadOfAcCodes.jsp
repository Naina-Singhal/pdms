...
<html lang="en">
    <head>
        ...
        <title>RPUM : Head Of Account Short Codes List</title>
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>Head Of Account Short Codes(s) <span> Add/ Update Group(s)</span></h2>
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="#">Head Of Account Short Codes(s)</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <section class="tile">
                                        ...
                                        <div class="tile-header dvd dvd-btm">
                                            <h1 class="custom-font"><strong>Head Of Account Short Codes</strong> Details</h1>
                                        </div>
                                        <!-- tile header -->
                                        <!-- tile body -->
                                        <div class="tile-body">
                                            <input type="hidden" id="hoaCodeId" name="hoaCodeId" value=""/>
                                            <div class="row">
                                                <div class="form-group div-wid-7">
                                                    <label for="username">Head Of Account: </label>                                                    
                                                    <select name="accountName" id="accountName" class="selectpicker form-control" 
                                                            data-live-search="true" data-dropup-auto="false">
                                                        <option value="null">select</option>
                                                    </select>
                                                    <label id="errorAccountName" style="color: red"></label>
                                                </div> 
                                                <div class="form-group div-wid-7">
                                            ...
                                            <div class="row">
                                                <div class="form-group div-wid-7">
                                                    ...
                                                    <textarea name="description"
                                                              id="description" maxlength="180"
                                                              class="form-control input-sm" cols="5" rows="5"></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile">
                                    <!-- tile header -->
                                    <div class="tile-header dvd dvd-btm">
                                        <h1 class="custom-font"><strong>Head Of Account Short Codes(s)</strong> List</h1>
                                    </div>
                                    <!-- tile header -->
                                    <!-- tile body -->
                                    <div class="tile-body">
        ...
        <script src="<c:url value="/appjs/master/HoaCodesJS.js"/>" type="text/javascript"></script>
