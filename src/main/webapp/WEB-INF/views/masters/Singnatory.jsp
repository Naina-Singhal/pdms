...
<html lang="en">
    <head>
        ...
        <title>RPUM : Signatory List</title>
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                <div class="page">
                    ...
                    <div class="pageheader">
                        <h2>Signatory(s) <span> Add/ Update Group(s)</span></h2>
                        <div class="page-bar">
                    ...
                    <div class="pagecontent">
                        ...
                        <%-- **************************************************************** --%>
                        <div class="row">
                            <spring:form name="addGroupForm" commandName="groupObj" id="signatory_form">
                                <!-- col -->
                                <div class="col-md-12">
                                    <!-- tile -->
                                    <section class="tile">
                                        ...
                                        <div class="tile-header dvd dvd-btm">
                                            <h1 class="custom-font"><strong>Signatory</strong> Details</h1>
                                        </div>
                                        <!-- tile header -->
                                        <!-- tile body -->
                                        <div class="tile-body">
                                            <input type="hidden" id="signatoryId" name="signatoryId" value=""/>
                                            <div class="row">                                                
                                                <div class="form-group col-md-6">
                                                    <label for="username">Signatory Code: </label>
                                                    <input type="text" name="signatoryCode" id='signatoryCode' 
                                                           class="form-control input-sm"
                                                           maxlength="40"/>
                                                    <label id="errorgroupCode" style="color: red"></label>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="username">Signatory Name: </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile">
                                    <!-- tile header -->
                                    <div class="tile-header dvd dvd-btm">
                                        <h1 class="custom-font"><strong>Currency(s)</strong> List</h1>
                                    </div>
                                    <!-- tile header -->
                                    <!-- tile body -->
                                    <div class="tile-body">
        ...
        <script src="<c:url value="/appjs/master/SignatoryJS.js"/>" type="text/javascript"></script>
