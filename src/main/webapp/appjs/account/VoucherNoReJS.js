 ...
 */
function openVouNoForm() {

    window.open("./supplierVouNoEn.htm", "_parent");
}
$(document).ready(function () {
    ...
    var table = $('#basic-usage').dataTable({
        ...
        "columns": [
            {title: "SL No", width: '5%'},
            {title: "Comp Code", width: '10%'},
            {title: "Supplier Name", width: '15%'},
            {title: "PO No", width: '11%'},
            {title: "Voucher NO", width: '13%'},
            {title: "Voucher Date", width: '15%'},
            {title: "Rtgs No", width: '15%'},
