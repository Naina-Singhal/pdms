...
$(document).ready(function () {
    ...
    var table = $('#basic-usage').dataTable({
        ...
        "columns": [
            {title: "SL No", width: '5%'},
            {title: "Requisition No", width: '10%'},
            {title: "To Be Delivered At", width: '15%'},
            {title: "Date", width: '11%'},
            {title: "Indentor", width: '13%'},
            {title: "Authorised By", width: '15%'},
            {title: "Issued By", width: '15%'},
...
function openMeteRequiEnForm() {

    window.open("./materialRequisition.htm", "_parent");
}
