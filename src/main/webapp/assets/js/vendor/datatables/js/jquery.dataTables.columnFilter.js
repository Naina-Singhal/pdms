...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            var sCSSClass = "text_filter form-control input-sm";
            if (bIsNumber)
                sCSSClass = "number_filter form-control input-sm";
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect) {
            ...
            var r = '<select class="search_init select_filter form-control input-sm" rel="' + i + '"><option value="" class="search_init">' + sLabel + '</option>';
			if(bMultiselect) {
				r = '<select class="search_init select_filter form-control input-sm" rel="' + i + '" multiple>';
			}
            var j = 0;
