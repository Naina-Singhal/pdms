...
public class PaymentDetailsController {
    private static final Logger log = Logger.getLogger(PaymentDetailsController.class);
    ...
    */ 
    ...
    public ModelAndView PaymentDetails(HttpServletRequest request, HttpServletResponse response) {
        ModelAndView modelView = new ModelAndView();
        try {
            modelView.addObject("userPermiLi", permissionServiceImpl.getUserPermissionObj(request));           
            modelView.setViewName("/accounts/PaymentDetails");
        } catch (Exception e) {
